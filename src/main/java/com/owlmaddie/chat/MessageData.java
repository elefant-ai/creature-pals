...
public class MessageData {
    ...
    public MessageData(String userLanguage, ServerPlayer player, String userMessage,
    ...
    public static MessageData genCharacterAndOrGreetingMessage(String userLanguage, ServerPlayer player, Entity entity){
